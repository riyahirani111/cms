    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('collegename', models.CharField(choices=[('AITR', 'AITR'), ('AIMSR', 'AIMSR')], max_length=29)),
                ...
                ('Branch', models.CharField(choices=[('CSE', 'CSE'), ('CSIT', 'CSIT'), ('EC', 'EC'), ('ME', 'ME')], default='CSE', max_length=29)),
            ],
        ),
        migrations.CreateModel(
            name='Grievance',
